...
and presented (\ref{gathering-domain-knowledge}~\nameref{gathering-domain-knowledge}). Following this, multiple
...
importance was compared across models (\ref{data-sources}~\nameref{data-sources}). In the
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_147_2.png}
    \end{center}
    { \hspace*{\fill} \\}
